...
pageEncoding="UTF-8"%> <%@include file="/WEB-INF/inc/taglib.jsp"%>
...
<!--//tags -->
<link href="${pageContext.request.contextPath}/static/web/css/bootstrap.css" rel="stylesheet" type="text/css"
	media="all" />
<link href="${pageContext.request.contextPath}/static/web/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="${pageContext.request.contextPath}/static/web/css/font-awesome.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/static/web/css/easy-responsive-tabs.css" rel='stylesheet'
	type='text/css' />
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					<div class="col-md-8 modal_body_left modal_body_left1">
						...
						<form action="${ applicationScope.basePath }/web/login" method="post" id="login">
							<div class="styled-input agile-styled-input-top">
								<input type="text" name="name" required=""> <label>用户名</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="password" name="pass" required=""> <label>密码</label>
								<span></span>
							</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					<div class="col-md-8 modal_body_left modal_body_left1">
						...
						<form action="${ applicationScope.basePath }/web/register" method="post" id="register">
							<div class="styled-input agile-styled-input-top">
								<input type="text" name="name" required=""> <label>用户名</label>
								<span></span>
							</div>
							...
							<div class="styled-input">
								...
								<label>确认密码</label> <span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="phone" required=""> <label>手机号</label>
								<span></span>
							</div>
							<div class="styled-input">
								<select id="country1" class="frm-field required sect" name="sex">
								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="${ applicationScope.basePath }/web/toSingle" class="link-product-add-cart">Quick
												View</a>
										</div>
									</div>
	...
	<!-- js -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/web/js/jquery-2.1.4.min.js"></script>
	<!-- //js -->
	<script src="${pageContext.request.contextPath}/static/web/js/modernizr.custom.js"></script>
	<!-- Custom-JavaScript-File-Links -->
	<!-- cart-js -->
	<script src="${pageContext.request.contextPath}/static/web/js/minicart.min.js"></script>
	<script>
		// Mini Cart
	...
	<script src="${pageContext.request.contextPath}/static/web/js/easy-responsive-tabs.js"></script>
	<script>
	...
	<!-- //script for responsive tabs -->
	<!-- stats -->
	<script src="${pageContext.request.contextPath}/static/web/js/jquery.waypoints.min.js"></script>
	<script src="${pageContext.request.contextPath}/static/web/js/jquery.countup.js"></script>
	<script>
		$('.counter').countUp();
	</script>
	<!-- //stats -->
	<!-- start-smoth-scrolling -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/web/js/move-top.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/web/js/jquery.easing.min.js"></script>
	...
	<!-- for bootstrap working -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/web/js/bootstrap.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/lib/layer/3.1.1/layer.js"></script>
	<script type="text/javascript">
  		...
  		$.ajax(
  		{
  			...
  			success:function(date)
  			{
  				if(date.statusCode == 200)
  				{
					...
					function()
					{
						location.href="${ applicationScope.basePath }/web/toIndex";
					});
  				}
  				else
  				{
