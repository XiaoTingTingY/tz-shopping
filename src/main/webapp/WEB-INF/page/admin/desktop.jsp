...
<body>
	<div class="wap-container">
			...
			<div class="panel">
				<div class="panel-body">
					<p class="f-20 text-success">
						欢迎使用管理后台<span class="f-14">v1.2</span>
					</p>
					<p>上次登录IP： 上次登录时间：${ sessionScope.consumer.mdtm }</p>
		...
		<footer class="footer Hui-admin-footer">
			<p>
				感谢jQuery、layer、laypage、Validform、UEditor、iconfont、Datatables、WebUploaded、icheck、highcharts、bootstrap-Switch<br> Copyright &copy;2019 <a href="${ applicationScope.basePath }/web/toIndex" target="_blank" title="OSSJK管理后台 v1.1">管理后台 v1.2</a> All Rights Reserved.<br> 本后台系统由<a href="http://www.h-ui.net/" target="_blank" title="H-ui前端框架">H-ui前端框架</a>提供前端技术支持
			</p>
		</footer>
	</div>
</body>
