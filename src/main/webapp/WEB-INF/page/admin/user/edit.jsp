	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="${pageContext.request.contextPath}${requestScope.record != null ?  '/admin/user/update' :'/admin/user/insert'  }" method="post" class="form form-horizontal" id="form">
					<!-- 隐藏表单 -->
					...
					<div class="row clearfix">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${requestScope.record.birthday }" placeholder="" id="birthday" name="birth">
						</div>
					</div>
					<div class="row clearfix">
