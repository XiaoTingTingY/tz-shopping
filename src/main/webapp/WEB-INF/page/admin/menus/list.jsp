...
<body>
	<div class="wap-container">
		<article class="Hui-admin-content clearfix">
			...
			<div class="panel-body">
				...
				<table class="table">
					<tr>
						<td width="200" class="va-t"><ul id="menus" class="ztree"></ul></td>
	...
	$("#toInsert").on('click', function()
	{
		...
		if(pid)
		{
			$("#testIframe").attr("src","${applicationScope.basepath}/admin/menus/toInsert?pid="+pid);
		}
		//如果没有则是直接添加一个节点
		else
		{
			$("#testIframe").attr("src","${applicationScope.basepath}/admin/menus/toInsert");
		}
		return false;
	});
	...
	$("#toUpdate").on('click', function()
	{
		...
		if(pid)
		{
			$("#testIframe").attr("src",'${applicationScope.basepath}/admin/menus/toUpdate?id=' + pid);
		}
		else
		{
			layer.msg("选择一条记录修改", 
	...
	{
		var url = '${applicationScope.basepath}/admin/menus/delete';
		if(pid)
		{
