		...
		<article class="Hui-admin-content clearfix">
			<div class="panel">
				<form class="search-form"
					action="${pageContext.request.contextPath}/admin/consumer/list">
					<div class="panel-body">
						<div class="row clearfix">
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="row clearfix mb-10">
									<span class="col-xs-4 form-item-label">consumer:</span> <span
				...
				<div class="panel-body">
					<div class="clearfix">
						<span class="f-l"> <a href="javascript:;"
							onclick="batchdel('${pageContext.request.contextPath}/admin/consumer/delete')"
							class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
								批量删除</a> <a href="javascript:;"
							onclick="insert('添加','${pageContext.request.contextPath}/admin/consumer/toInsert','800','500')"
									...
									<c:forEach var="record"
										...
										<tr class="text-c">
											...
											<td><a title="编辑" href="javascript:;"
												onclick="update('编辑','${pageContext.request.contextPath}/admin/consumer/toUpdate?id=${record.id}','1','800','500')"
												class="ml-5" style="text-decoration: none"><i
													class="Hui-iconfont">&#xe6df;</i></a> <a title="删除"
												href="javascript:;"
												onclick="del(this,'${pageContext.request.contextPath}/admin/consumer/delete?id=${record.id}')"
												class="ml-5" style="text-decoration: none"><i
													class="Hui-iconfont">&#xe6e2;</i></a>
													
													<a title="角色"
												href="javascript:;"
												onclick="toEditRole(this,'${pageContext.request.contextPath}/admin/consumer/toEditRole?id=${record.id}')"
												class="ml-5" style="text-decoration: none"><i
...
<script src="${pageContext.request.contextPath}/static/admin/lib/echarts/4.1.0.rc2/echarts.min.js"></script>
	...
	<script type="text/javascript">
		...
		function toEditRole(title, url, w, h) {
			//hui自己封装的方法
			//里面底层实现就是layer.open()
			layer_show(title, url, w, h);
		}
