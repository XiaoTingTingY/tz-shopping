...
public abstract class CommonUtil extends CommonMethod {
	 ...
	 */
	public static <T> T cloneJavaBean(Object objSource, Class<T> clazz)
	 ...
	 * 
	 * @param txDate
	 * @param proi   // BigDecimal(int) 创建一个具有参数所指定整数值的对象。 //BigDecimal(double)
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static List<byte[]> toByteArray(String s, int len, String charset, int agliment)
			throws UnsupportedEncodingException {
	 ...
	 * @param bigDecimal 数字
	 * @param len
	 * @param prec       在bigDecimal后添加小数点，添加相应长度的0
	 * @return
	 */
	 ...
	 * @param source
	 * @param position    替换第position位开始的length长度字符
	 ...
	 * @param replacement 替换字符串
	 * @param source
	 * @param position    替换第position位开始的字符，将source直接替换到replacement中,
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @param replacement 替换字符串
	 * @param source      直接从replacement第一位开始替换
	 * @return
	 */
	 ...
	 * 字符串前面补0.
	 * 
	 * @param source    需要补0的字符串
	 * @param sourceLen 补多少位0(但包含字符串的长度，如：sourceLen=5，source.length=3，则source前会补给2个0)
	 * @return
	 */
